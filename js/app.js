...
function multiply(a, b) { //eslint-disable-line
  let multi = a*b;
  let multi_string = "The product of "+a+" and "+b+" is "+multi+".";
  return [multi, multi_string];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  return [sum, product, sum_string, product_string];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  let fi_element = sumAndMultiply(testArray[0],testArray[1],testArray[2])[1];
  let sec_element = "The numbers "+ testArray+" have a product of "+fi_element+".";
  return [fi_element, sec_element]; 
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (let i = 0; i < testDynamicArray.length ; i++) {
    fi_element = multiply(fi_element,testDynamicArray[i])[0];
    }
  let sec_element = "The numbers "+ testDynamicArray+" have a product of "+fi_element+".";
  return [fi_element,sec_element];
  }
